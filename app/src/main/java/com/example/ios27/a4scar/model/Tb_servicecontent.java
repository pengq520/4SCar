...
public class Tb_servicecontent //维修项目信息实体类
{
    private int _id; //存储维修项目编号
    private String content; //存储维修项目信息
    private double money; //存储价格信息
    private String mark; //存储备注信息

    public Tb_servicecontent(){ //默认构造函数
        super();
    }

    //定义有参构造函数，用来初始化维修项目信息实体类中的各个字段
    public Tb_servicecontent(int id, String content,double money,String mark){
        super();
        //赋值
        this._id=id;
